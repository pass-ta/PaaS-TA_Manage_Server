    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.IntegerField(default=0, verbose_name='퀴즈 점수')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maker', models.EmailField(max_length=64, null=True, verbose_name='생성자 이메일')),
                ('makername', models.CharField(default='NULL', max_length=128, verbose_name='생성자 이름')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='질문 아이디')),
                ('user', models.EmailField(max_length=64, null=True, verbose_name='사용자 이메일')),
                ('room_id', models.CharField(default=None, max_length=128, verbose_name='방 아이디')),
                ('question', models.CharField(default='aaa', max_length=64, verbose_name='질문')),
                ('item1', models.CharField(default='aaa', max_length=128, verbose_name='질문지1')),
                ('item2', models.CharField(default='aaa', max_length=128, verbose_name='질문지2')),
                ('item3', models.CharField(default='aaa', max_length=128, verbose_name='질문지3')),
                ('item4', models.CharField(default='aaa', max_length=128, verbose_name='질문지4')),
                ('answer', models.IntegerField(default='0', verbose_name='정답')),
